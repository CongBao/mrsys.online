              ...
              <s:if test="#session.user != null">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="/user/${sessionScope.user.id}#profile"><span class="glyphicon glyphicon-book"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;View Your Profile</a></li>
                        <li><a href="/user/${sessionScope.user.id}#setting"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;User Settings</a></li>
                        <li role="separator" class="divider"></li>
